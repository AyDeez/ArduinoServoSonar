...
* aux.h - header file containing the declarations of the aux functions used in the main and the various defines
* aux.c - file containing the implementation of the aux functions
